        ...
        <el-dialog v-model="dialogVisible" :title="dialogType === 'edit' ? 'Edit Role' : 'New Role'">
            <el-form :model="role" label-position="left" label-width="80px">
                ...
                <el-form-item label="Desc">
                    <el-input v-model="role.description" :autosize="{minRows: 2, maxRows: 4}" placeholder="Role Description" type="textarea" />
                </el-form-item>
                <el-form-item label="Menus">
                    <el-tree ref="treeRef" :check-strictly="checkStrictly" :data="routesTreeData" :props="defaultProps" class="permission-tree"
