<template>
    <div class="app-container">
        ...
        <el-table ref="draggableTable" v-loading="listLoading" :data="list" border fit highlight-current-row row-key="id" style="width: 100%">
            ...
            <el-table-column label="Importance" width="105px">
                <template #default="{row}">
                    <svg-icon v-for="n in +row.importance" :key="n" class="icon-star" name="star" />
                </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="Drag" width="80">
                <svg-icon class="draggable-handler" height="20" name="drag" width="20" />
            </el-table-column>
        </el-table>
