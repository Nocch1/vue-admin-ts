<template>
    <div class="components-container">
        <aside>
            ...
            <a class="link-type" href="https://armour.github.io/vue-typescript-admin-docs/features/components/rich-editor.html"
               target="_blank">{{ t('components.documentation') }}</a>
        </aside>
        <div>
